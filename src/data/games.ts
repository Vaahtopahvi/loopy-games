...
export const games: Game[] = [
  ...
  },
  {
    ...
    rating: 5,
    review:
      "Get ready to become addicted to OSRS. There's just too much to do, too many quests to complete, and too many skills to grind. So many wasted hours just to get to max level and to obtain your favorite pet from the boss.",
    interestingFact:
      "Other people can't trim your armor",
    coverImage: "src/public/covers/osrs.webp",
    gameType: "story",
    recommended: true,
    isOngoing: true,
    completionist: false,
